...
<!--    &lt;!&ndash; Dynamic Background &ndash;&gt;-->
...
<!--        &lt;!&ndash; Game Detail Modal &ndash;&gt;-->
<!--          <div v-if="selectedGame"-->
<!--               class="fixed inset-0 z-50 flex items-center justify-center bg-black/80"-->
<!--               @click="closeGameDetail">-->
<!--          &lt;!&ndash; Modal (이벤트 전파 중지) &ndash;&gt;-->
...
<!--              &lt;!&ndash; YouTube Videos Section &ndash;&gt;-->
...
//     router.push('/')
//   } else if (!authStore.isLoggedIn && router.currentRoute.value.meta.requiresAuth) {
//     router.push('/login')
//   }
// })
</script>
